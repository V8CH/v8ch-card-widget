...
<p><label for="<?php echo $this->get_field_id('cat'); ?>"><?php _e('Taxonomy Slug', 'image_widget'); ?>:</label>
	<input class="widefat" id="<?php echo $this->get_field_id('cat'); ?>" name="<?php echo $this->get_field_name('cat'); ?>" type="text" value="<?php echo esc_attr(strip_tags($instance['cat'])); ?>" /></p>
